<?php return array (
  ...
  array (
    ...
    array (
      ...
      5 => '(CD4528) For C__EXT > 0.01 &micro;F and Vcc = 5V, output pulse width = 0.2 &times; R__EXT &times; C__EXT.',
      6 => '(HEF4528) For C__EXT > 0.01 &micro;F and Vcc = 5V, output pulse width = 0.42 &times; R__EXT &times; C__EXT.',
    ),
  ),
  4538 => 
  array (
    ...
    array (
      ...
      3 => 'A low-to-high transition on nB when n~A is high causes a pulse on nQ and n~Q.',
      4 => 'Setting n~CD low inhibits pulses.',
      5 => 'Output pulse width = R__EXT &times; C__EXT.',
      6 => '(74HC4538) Output pulse width = 0.7 &times; R__EXT &times; C__EXT.',
    ),
  ),
  4541 => 
  array (
    ...
    'notes' => 
    array (
      0 => 'The RC oscillator frequency is 1/(2.3 &times; R__t &times C__t). R__S = 2R__t.',
  ...
  array (
    ...
    'notes' => 
    array (
      0 => 'In monostable mode, pulse width &asymp; 1.1RC',
...
<tr><td>$0F</td><td>Same as register $01, but with no effect on handshake</td></tr>
      ...
      4 => 'Counters for timers in one-shot or free-running mode decrement at the &empty;2 clock rate.',
  ...
  array (
    ...
    array (
      ...
      2 => 'Filter cutoff frequency is approx. 2.6&times;10<sup>-5</sup>/C (where C is the value of C1 or C2).',
      3 => 'POTX and POTY pins must be connected to RC networks; the time constant RC should be 4.7&times;10<sup>-4</sup>. Recommended capacitor value is 1000 pF, recommended potentiometer value is 470 k&Omega;.',
      4 => 'Maximum audio output level is approx. 3V p-p at a 6V DC level. A 1k&Omega; resistor should be connected from AUDIO OUT to ground, and a 1-10&micro;F electrolytic capacitor should be used for AC coupling.',
      5 => 'Registers:
<table>
...
<tr><td>$1C</td><td>Upper 8 bits of Voice 3 envelope generator value</td></tr>
      ...
      6 => 'Oscillator frequency = (Fn &times; Fclk/16777216) Hz',
...
<tr><td>FFF1-FFF1</td><td>Reserved</td></tr>
  ...
  array (
    ...
    'notes' => 
    array (
      0 => 'A 10 k&Omega; potentiometer connected to pins 1 and 5 can be used to null any offset voltage.',
    ),
  ),
  7410 => 
  array (
  ...
  array (
    ...
    array (
      0 => 
      array (
        'param' => 'Propagation delay, I__n to &Sigma;__E',
        'val' => 
        array (
          0 => '17 (74HC)',
          1 => '18 (74HCT)',
      ...
      1 => 
      array (
        'param' => 'Propagation delay, I__n to &Sigma;__O',
        'val' => 
        array (
          0 => '20 (74HC)',
          1 => '22 (74HCT)',
  ...
  array (
    ...
    array (
      ...
      1 => 'S1 is high and S0 is low; shift left (DSL &rarr; Q7, Q7 &rarr; Q6...)',
      2 => 'S1 is low and S0 is high; shift right (DSR &rarr; Q0, Q0 &rarr; Q1...)',
      3 => 'S1 and S0 are high; parallel load (I/On &rarr; Qn)',
    ),
  ),
  7430 => 
  array (
  ...
  array (
    ...
    array (
      ...
      array (
        'num' => 6,
        'sym' => '2Y',
        'desc' => 'data output (2A &middot; 2B) + (2C &middot; 2D)',
      ),
      6 => 
      array (
        'num' => 7,
      ...
      array (
        'num' => 8,
        'sym' => '1Y',
        'desc' => 'data output (1A &middot; 1B &middot; 1C) + (1D &middot; 1E &middot; 1F)',
      ),
      8 => 
      array (
        'num' => 9,
...
<tr><td>Bits 1-3</td><td>specify bit to modify (0-7)</td></tr>
  ...
  array (
    'name' => 'ATTiny12',
    'description' => '8-Bit AVR&reg; microcontroller with 1 kb In-system programmable flash memory',
    'aliases' => 
    array (
      0 => 'ATTiny12V-1',
      1 => 'ATTiny12L-4',
...
<tr><td>$0F</td><td>I/O port B data</td></tr>
  ...
  array (
    ...
    array (
      0 => 
      array (
        'param' => 'Frequency stability, 0&deg;C to +40&deg;C',
        'val' => '&plusmn;2.0',
        'unit' => 'ppm',
      ),
      1 => 
      array (
        'param' => 'Frequency stability, -40&deg;C to +85&deg;C',
        'val' => '&plusmn;7.5',
        'unit' => 'ppm',
      ),
    ),
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'val' => '1 &times; 10<sup>12</sup>',
        'unit' => 'rad(Si)/s',
      ),
      3 => 
      array (
        'param' => 'Total dose',
        'val' => '1 &times; 10<sup>6</sup>',
        'unit' => 'rad(Si)',
      ),
      4 => 
      array (
        'param' => 'Neutron fluence',
        'val' => '5 &times; 10<sup>13</sup>',
        'unit' => 'n/cm<sup>2</sup>',
      ),
      5 => 
      array (
        ...
        'val' => 
        array (
          0 => '2 &times; 10<sup>5</sup> (min)',
          1 => '2 &times; 10<sup>7</sup> (max)',
        ),
        'unit' => 'rad(Si)/s',
      ),
    ),
  ...
  array (
    ...
    'notes' => 
    array (
      0 => 'Basic negative voltage converter: 10&micro;F capacitor across pins 2 and 4; 10&micro;F capacitor across pin 5 (negative lead) and ground (positive lead).',
    ),
  ),
  'ICM7228B' => 
  array (
  ...
  array (
    ...
    array (
      ...
      1 => 'C1 through C5 should be 1.0 &micro;F electrolytic capacitors.',
    ),
  ),
  'MC34063' => 
  array (
...
cycle rate.',
  ...
  'PIC18F13K50' => 
  array (
    'description' => '20-Pin USB Flash Microcontrollers with nanoWatt XLP&trade; Technology',
    'aliases' => 
    array (
      0 => 'PIC18F14K50',
    ),
  ...
  array (
    ...
    'notes' => 
    array (
      0 => 'Decimal points are driven independently and current-limiting resistors (typically 1k&Omega;) are required.',
    ),
  ),
  'TL081' => 
  array (
